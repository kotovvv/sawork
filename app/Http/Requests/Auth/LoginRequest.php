...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        // Convert password into hash according to algorithm in Lomag
        $passwordHash = $this->getPasswordHash($this->input('password'));

        // Load user from Uzytkownik table
        $user = User::where('Login', $this->input('email'))->first();
