...
class ClientApiController extends Controller
{
    ...
    public function upsertOrder(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'delivery.fullname' => 'nullable|string',
            'delivery.company' => 'nullable|string',
            'delivery.phone' => 'nullable|string',
            'delivery.country_code' => 'nullable|string|size:2',
            ...
            'delivery.house_number' => 'nullable|string',
            'delivery.apartment' => 'nullable|string',
            'delivery.price' => 'nullable|numeric|min:0',
            'delivery.method' => 'nullable|string',
            'delivery.method_id' => 'nullable|integer',
            'delivery.point' => 'nullable|array',
            'delivery.point.name' => 'nullable|string',
            'delivery.point.id' => 'nullable|string',
            'delivery.point.address' => 'nullable|string',
            'delivery.point.postcode' => 'nullable|string',
            'delivery.point.city' => 'nullable|string',
    ...
    private function transformApiOrderToBaseLinkerFormat(array $apiData)
    {
        ...
        return [
            ...
            'delivery_phone' => $apiData['delivery']['phone'] ?? '',
            'delivery_address' => $apiData['delivery']['street'] . ' ' . ($apiData['delivery']['house_number'] ?? '') . '/' . ($apiData['delivery']['apartment'] ?? ''),
            'delivery_street' => $apiData['delivery']['street'] ?? '',
            'delivery_house_number' => $apiData['delivery']['house_number'] ?? '',
            'delivery_apartment' => $apiData['delivery']['apartment'] ?? '',
            ...
            'delivery_point_id' => $apiData['delivery']['point']['id'] ?? null,
            'delivery_point_name' => $apiData['delivery']['point']['name'] ?? null,
            'delivery_point_address' => $apiData['delivery']['point']['address'] ?? null,
            'delivery_point_postcode' => $apiData['delivery']['point']['postcode'] ?? null,
            'delivery_point_city' => $apiData['delivery']['point']['city'] ?? null,
