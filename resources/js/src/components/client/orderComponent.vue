          ...
          <v-col cols="12" md="7">
            ...
            <v-row>
              <v-col cols="6">
                ...
                <div><b>Źródło:</b> {{ client._OrdersTempString7 || "" }}</div>
              </v-col>
              <v-col cols="6">
                <div>
                  <b>Sposób wysyłki:</b> {{ delivery.delivery_method || "..." }}
                </div>
        ...
        <v-row class="mt-2">
          <v-col cols="12" md="4">
            <v-card class="pa-3" variant="outlined">
              ...
              <div><b>Firma:</b> {{ delivery.delivery_company || "..." }}</div>
              <div><b>Adres:</b> {{ delivery.delivery_address || "..." }}</div>
              <div>
                <b>Kod i miasto:</b> {{ delivery.delivery_postcode || "..." }}
                {{ delivery.delivery_city || "..." }}
              </div>
              <div>
                <b>Województwo:</b> {{ delivery.delivery_state || "..." }}
              </div>
              <div><b>Kraj:</b> {{ delivery.delivery_country || "..." }}</div>
            </v-card>
          </v-col>
          <v-col cols="12" md="4">
            <v-card class="pa-3" variant="outlined">
              ...
              <div>
                <b>Imię i nazwisko:</b> {{ delivery.invoice_fullname || "..." }}
              </div>
              <div><b>Firma:</b> {{ delivery.invoice_company || "..." }}</div>
              <div><b>Adres:</b> {{ delivery.invoice_address || "..." }}</div>
              <div>
                <b>Kod i miasto:</b> {{ delivery.invoice_postcode || "..." }}
                {{ delivery.invoice_city || "" }}
              </div>
              <div><b>NIP:</b> {{ delivery.invoice_nip || "" }}</div>
              <div><b>Kraj:</b> {{ delivery.invoice_country || "..." }}</div>
            </v-card>
          </v-col>
          <v-col cols="12" md="4">
            <v-card class="pa-3" variant="outlined">
