  ...
  <v-container>
    ...
    <v-row v-if="products.length">
      <v-col>
        ...
        <div class="row mb-3">
          <div class="qty input-group" v-if="edit.id > 0">
        ...
        <div class="products" v-for="(p, i) in products" :key="p.IDTowaru">
          <div
            class="product"
            @click="
          ...
          >
            ...
            <span v-if="p.qty" style="color: green">
    ...
    <section class="row" v-if="products.find((e) => e.qty > 0)">
      <div class="col">
        <p>Niepełnowartościowe</p>
        <label><input type="radio" v-model="full" value="0" />Nie</label><br />
        <label><input type="radio" v-model="full" value="1" />Tak</label>
      </div>
      <div class="col">
        <button class="btn btn-primary my-3" @click="doWz()">
...
export default {
  ...
  methods: {
    ...
    changeCounter: function (num) {
      this.edit.qty = parseInt(this.edit.qty) + parseInt(+num);
      if (this.edit.qty > this.edit.max) {
        this.dialog_text =
          "Dla tego zamówienia maksymalna ilość tego produktu wynosi = " +
          this.edit.max;
        this.dialog = true;
      }
      this.edit.qty =
        this.edit.qty < this.edit.max ? this.edit.qty : this.edit.max;
      !isNaN(this.edit.qty) && this.edit.qty > 0
        ? this.edit.qty
        : (this.edit.qty = 0);
    },
    saveEdit() {
    ...
    editProduct(product, add) {
      ...
      this.edit.qty = parseInt(this.edit.qty) + parseInt(add);
      if (this.edit.qty > this.edit.max) {
